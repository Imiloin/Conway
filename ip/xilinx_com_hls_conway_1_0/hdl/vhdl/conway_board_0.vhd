...
architecture rtl of conway_board_0_ram is 
...
architecture arch of conway_board_0 is
    component conway_board_0_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    conway_board_0_ram_U :  component conway_board_0_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
